...
<!-- зона заголовка html, тег <title> - строка, которую браузер отображает на вкладках над страницами, <meta> и <link> сообщают технические сведения для браузера, например, что файл имеет кодировку Юникод (utf-8) -->
	...
	<head>
		<title>Личная страница Алёны Федотовой</title>
	 	<!-- Required meta tags -->
	 	<meta charset="utf-8">
...
<!-- начинается шапка. у тега header есть атрибут style, который задает цвет фона и отступы. поменяйте значения атрибутов и посмотрите, как изменится страница -->
		...
		<header style="background-color:LightSkyBlue; padding-top:75px; "> 
			<div class="container"> 
				<div class="row">
					<div class="col-md-4">
						<br><br>
<!-- здесь и дальше нужно поменять весь содержательный текст, чтобы получилась ваша личная страница -->
						<h1>Алёна Федотова</h1>
						<hr> <!-- это горизонтальная линия -->
						<p><b>всем привет! поскольку ниже будет место для того, чтобы рассказать о себе, тут просто будет пояснение моего ника в гитхабе (и не только). моя любимая музыальная группа - Panic! At the Disco, а Time to Dance (которая, кстати, является кратким пересказом моей любимой книжки Чака Паланика "Невидимки") - любимая песня уже очень много лет. оттуда, собственно говоря, и берется фраза: "give me envy, give me malice, give me your attention"</p> 
					</div>
					<div class="col-md-4">
